...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="document">
		<HEAD>
			...
			<TITLE>旅途國際 &#187; 完成加入微網店家的申請註冊</TITLE>
		</HEAD>
		<xsl:comment>
			...
			<DIV class="rightContent">
				<DIV>
					...
					<P style="text-align:center">
						<IMG alt="完成加入微網店家的申請註冊" src="/IMG/joinedAndWelcome.png"/>
					</P>
					<DIV>
						<!--<xsl:value-of select="step3Html" disable-output-escaping="yes"/>-->
						<H1 style="text-align: center;">
							<SPAN style="color:#FF8C00">歡迎您加入微網店家</SPAN>
						</H1>
						<H2>系統已經發送了一封確認信到您註冊的信箱， 請至信箱中查看及確認相關資料，再次感謝您的加入與參與，讓我們一起攜手努力 為明日的電子商務，打造出美好的網路世界平台!!</H2>
					</DIV>
				</DIV>
			</DIV>
