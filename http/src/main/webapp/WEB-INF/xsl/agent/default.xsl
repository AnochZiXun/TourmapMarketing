	...
	<xsl:template match="document">
		...
		<BODY>
			...
			<DIV class="rightContent">
				<DIV>
					<DIV>
						<H1>旅圖國際業務後台管理：<xsl:value-of select="name"/></H1>
						<OL>
							<LI>
								<SPAN>Google Apps管理 (mail 雲端硬碟 行事曆 視訊)</SPAN>
								<A class="button redButton" href="https://www.gmail.com/" target="_blank">登入</A>
							</LI>
							<LI>
								<SPAN>業務查看 (管理微網店家 + 業務員)</SPAN>
								<A class="button yellowButton" href="http://tour-map.net/crm/" target="_blank">查看</A>
							</LI>
							<!--
							奉偉寬哥指示於2016-09-09拿掉
							<LI>
								<SPAN>店家歐付寶帳號登入</SPAN>
								<A class="button greenButton" href="javascript:void(0)">登入</A>
							</LI>
							-->
							<LI>
								...
								<TABLE class="heWeiKuan">
									...
									<TBODY>
										<TR>
											<TD>1</TD>
											<TD style="text-align:left">月費</TD>
											<TD>
										...
										<TR>
											<TD>2</TD>
											<TD style="text-align:left">Google 費用</TD>
											<TD>(n/a)</TD>
											<TD>
